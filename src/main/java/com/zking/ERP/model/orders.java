...
public class orders {
    ...
    public orders(Integer uuid, Date createtime, Date checktime, Date starttime, Date endtime, String type, Integer creater, Integer checker, Integer starter, Integer ender, Integer supplieruuid, Integer totalmoney, String state) {
        this.uuid = uuid;
